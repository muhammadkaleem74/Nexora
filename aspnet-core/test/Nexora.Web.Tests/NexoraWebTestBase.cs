...
public abstract class NexoraWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static NexoraWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(NexoraWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<NexoraDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<NexoraDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<NexoraDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<NexoraDbContext, Task<T>> func)
    {
        T result;
